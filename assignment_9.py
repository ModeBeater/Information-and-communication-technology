...
logisticRegr.fit(feature,label)
predictions = logisticRegr.predict(feature_predict)
predictions_proba=logisticRegr.predict_proba(feature_predict)
# predictions[0]= 5
